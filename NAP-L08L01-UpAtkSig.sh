...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap/main/lab08/{nginx,nap}.conf
...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap/main/lab08/{policy_viol_filetype.json,my-filetypes.txt,local-policy.json}
