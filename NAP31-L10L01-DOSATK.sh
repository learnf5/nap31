...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab08/policy_viol_filetype.json
sudo scp /tmp/policy_viol_filetype.json                    nginx:/etc/app_protect/conf/nap.d
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab08/{my-filetypes.txt,{local-policy}.json,app-protect-security-updates.key}
...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab09/{uds,user_sig_policy}.json
sudo scp /tmp/user_sig_policy.json                    nginx:/etc/app_protect/conf/nap.d
sudo scp /tmp/uds.json                    nginx:/etc/app_protect/conf/nap.d

curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab10/{{nginx,nap}.WAF,policy_data_guard.json}
...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab10/GoodTraffic.sh
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/nap31/main/lab10/BadTraffic.sh
