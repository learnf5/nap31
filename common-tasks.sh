...
# ALL licenses from NGINX One - will it work for updating NAP DoS??? NO it doesn't work for me with NAP DoS!!!
# So we have a problem since Salesforce no longer has NGINX Plus trial licenses.
